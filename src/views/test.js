...
module.exports = state => main(`
  <form action="/auth" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" name="username" id="username-input"  placeholder="Username" value="${!state.filters.check(state, 'global', 'flash', 'params') ? 'User2' : `${state.global.flash.params.username}`}" required />
    </div>
    <div class="form-group">
